...
default['cookbook_youtrack']['youtrack']['version'] = '2020.3.9516'
...
default['cookbook_youtrack']['youtrack']['download_url'] = 'https://download.jetbrains.com/charisma/youtrack-2020.3.9516.zip'
