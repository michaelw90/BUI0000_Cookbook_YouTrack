...
default['cookbook_youtrack']['youtrack']['version'] = '7.0.28958'
...
default['cookbook_youtrack']['youtrack']['download_url'] = 'https://download.jetbrains.com/charisma/youtrack-7.0.28958.zip'
