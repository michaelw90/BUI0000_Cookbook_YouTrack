...
default['cookbook_youtrack']['youtrack']['version'] = '2017.4.38399'
...
default['cookbook_youtrack']['youtrack']['download_url'] = 'https://download.jetbrains.com/charisma/youtrack-2017.4.38399.zip'
