...
default['cookbook_youtrack']['youtrack']['version'] = '6.5.17105'
...
default['cookbook_youtrack']['youtrack']['download_url'] = 'https://download.jetbrains.com/charisma/youtrack-6.5.17105.zip'
